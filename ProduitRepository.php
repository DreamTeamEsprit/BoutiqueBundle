...
class ProduitRepository extends \Doctrine\ORM\EntityRepository
{
    function findDQL($libelle, $categorie, $prix)
    {
        ...
        $req = $qb->select('p')
            ->from('SanteUserBundle:Produit', 'p')
            ->join('p.categorie', 'c');
    ...
    function  triermoinsDQL()
    {
        $query=$this->getEntityManager()
            ->createQuery("
            select p from SanteUserBundle:Produit p
            order by p.prix ");
    ...
    /*
            ...
            function  findCategorieDQL()
            {
                $query=$this->getEntityManager()
                    ->createQuery("
                    select p from SanteUserBundle:Produit p JOIN
                    SanteUserBundle:Categorie c
